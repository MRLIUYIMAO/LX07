   ...
   public class WorkInfo
    {
        ...
        public IEnumerable<Model.WorkInfoNo> GetFindPage(Model.WorkFindPage page)  //返回第n页活动数据
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
        ...
        public IEnumerable<Model.WorkInfoNo> GetMyPage(Model.WorkMyPage page)  //返回第n页活动数据
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
